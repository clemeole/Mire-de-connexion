...
$(document).ready(function() {
  ...
  containerClassroom.click(function() {
    ...
    $(".classroomImage").click(function() {
      //opacityDown(cursorClassroom, 200);
...
function createPupills() {
  ...
  $(".pupillImage").click(function() {
    ...
    setTimeout(function() {
      /*Quand l'élève a cliqué sur son icone, automatiquement il redirigé vers le bloc pour entrer son mdp*/
      if (right == true) {
        toEnd();
      }
