...
$(document).ready(function() {
  ...
  btnCheck.click(function() {
    ...
    if ($("#containerClassroom").children().attr("src") == "img/classroomDefault.svg" && $("#containerPupil").children().attr("src") == "img/pupillDefault.png") {
    ...
    } else if ($("#containerPupil").children().attr("src") == "img/pupillDefault.png") {
